...
import com.example.codewars.databinding.RowLoadingErrorBinding

class ChallengeItemsLoadStateAdapter(
    private val onRetry: (() -> Unit)? = null
) : LoadStateAdapter<ChallengeItemsLoadStateAdapter.ViewHolder>() {
